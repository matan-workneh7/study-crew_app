...
-- Assistant courses (many-to-many relationship)
...
-- Insert sample data
INSERT INTO users (username, full_name, email, password, academic_year, roles) VALUES 
('testuser', 'Test User', 'test@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Sophomore', '["student"]'),
('testassistant', 'Test Assistant', 'assistant@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Senior', '["assistant"]');
